      ...
      content: (
        <div className='w-full overflow-hidden relative h-full rounded-2xl p-10 bg-gradient-to-br text-white from-slate-800 to-slate-900'>
          ...
          <p className='text-lg text-slate-400'>
            ...
            Let me help you create a solid foundation for your web applications
          </p>
        </div>
      ),
    },
      ...
      content: (
        <div className='w-full overflow-hidden relative h-full rounded-2xl p-10 bg-gradient-to-br text-white from-slate-800 to-slate-900'>
          ...
          <p className='text-lg text-slate-400'>
            ...
            specialize in collecting, processing, and analyzing data to provide
            actionable insights that drive informed decision-making. Using tools
            like SQL, Python, and data visualization like Google Looker, I help
            businesses understand trends, customer behavior, and performance
            metrics. Whether you need to optimize your marketing strategies or
            improve operational efficiency, I can turn your data into a
            strategic asset
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className='w-full overflow-hidden relative h-full rounded-2xl p-10 bg-gradient-to-br text-white from-slate-800 to-slate-900'>
          ...
          <p className='text-lg text-slate-400'>
            Enhance your applications with seamless API Integration services. I
            specialize in connecting various software systems and services to
            streamline workflows and improve functionality. Whether integrating
            third-party services, payment gateways, or custom APIs, I ensure
            smooth communication between your applications. My goal is to create
            a cohesive ecosystem that enhances user experience and maximizes the
            potential of your digital solutions
          </p>
        </div>
      ),
    },
